...
import com.fh.service.ceshi.sysAppUserCopy.SysAppUserCopyService;
 ...
 */
@Controller
@RequestMapping(value="/sysAppUserCopy")
public class SysAppUserCopyController extends BaseController {
	
	@Resource(name="sysAppUserCopyService")
	private SysAppUserCopyService sysAppUserCopyService;
	...
	public ModelAndView save(@RequestParam(value="NAME",required=false) MultipartFile NAME_FILE,@RequestParam(value="IP",required=false) MultipartFile IP_FILE,
...
@RequestMapping(value="/edit")
	public ModelAndView edit(@RequestParam(value="NAME",required=false) MultipartFile NAME_FILE,@RequestParam(value="IP",required=false) MultipartFile IP_FILE,
							 MultipartHttpServletRequest request) throws Exception{
