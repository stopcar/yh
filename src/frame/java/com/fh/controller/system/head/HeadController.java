...
import com.fh.service.system.createCodeByTable.CodeByTableService;
...
public class HeadController extends BaseController {
	...
	@Resource(name="codeByTableService")
	private CodeByTableService codeByTableService;
	/**
	 * 获取头部信息
	 */
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/goProductCodeByTable")
	public ModelAndView goProductCodeByTable() throws Exception{
		PageData pd = new PageData();
		List<PageData> schemaList = codeByTableService.findTableBySchema(pd);
		ModelAndView mv = this.getModelAndView();
		mv.addObject("schemaList", schemaList);
		mv.setViewName("system/head/productCodeByTable");
		mv.addObject("pd", pd);
		mv.addObject(Const.SESSION_QX,this.getHC());	//按钮权限
		return mv;
	}
	
	@RequestMapping(value="/findTableBySchema")
	@ResponseBody
	public Object findTableBySchema() throws Exception{
		PageData pd = this.getPageData();
		List<PageData> tableList = codeByTableService.findTableBySchema(pd);
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("tableList", tableList);
		return AppUtil.returnObject(pd, map);
	}
	
	@RequestMapping(value="/findColsByTable")
	@ResponseBody
	public Object findColsByTable() throws Exception{
		PageData pd = this.getPageData();
		List<PageData> colList = codeByTableService.findColsByTable(pd);
		Map<String,Object> map = new HashMap<String,Object>();
