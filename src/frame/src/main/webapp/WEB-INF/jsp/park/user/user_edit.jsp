        ...
        <div class="row-fluid">
            ...
            <div class="span6" style="margin: 5px auto auto 5px;">
                <div class="span12" style="border-style: outset;height: 800px; width:1075px;background-color:#F0F8FF; ">
                    ...
                    <div class="span8">
                        <div class="span12">
                            <form action="/park_editUserInfo.do" method="post" class="form-horizontal">
                                <table style="margin: 45px auto auto 80px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="hidden" id="inputuserID" name="userID" value="${userInfo.userID}" >
                                            <input type="text" id="inputusername" name="userName" value="${userInfo.userName}" placeholder="亲、好记才是重点">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="password" id="inputPassword" name="password" value="${userInfo.password}" placeholder="密码">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="password" id="inputenterpassword" name="enterpassword" value="${userInfo.enterpassword}" placeholder="确认密码">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="text" id="inputgender" name="gender" value="${userInfo.gender}" placeholder="男/女">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="number" id="inputqqnum" name="qq" value="${userInfo.qq}" placeholder="QQ号">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="text" id="inputweiXin" name="weiXin" value="${userInfo.weiXin}" placeholder="微信号">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="number" id="inputmobilePhon" name="mobilePhon" value="${userInfo.mobilePhon}" placeholder="手机号">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="email" id="inputemailBox" name="emailBox" value="${userInfo.emailBox}" placeholder="常用邮箱">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td style="padding-top: 15px;">
                                            <input type="text" id="inputuserQuestionone" name="userQuestionone" value="${userInfo.userQuestionone}" placeholder="问题">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="text" id="inputuserQuestiononeans" name="userQuestiononeans" value="${userInfo.userQuestiononeans}" placeholder="答案">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="text" id="inputuserQuestiontwo" name="userQuestiontwo" value="${userInfo.userQuestiontwo}" placeholder="问题">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-top: 10px;">
                                            <input type="text" id="inputuserQuestiontwoans" name="userQuestiontwoans" value="${userInfo.userQuestiontwoans}" placeholder="答案">
                                            <span style="color:red;font-size: 20px;">*</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 20px;">
                                            <button type="submit" class="btn btn-block" style="width: 218px;">修改用户</button>
                                        </td>
                                    </tr>
                                </table>
                            </form>
